                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        ...
                                        <form action="<?php echo base_url() ?>index.php/C_produksi/simpanDataHargaPokokProduksi" class="form-horizontal" method="post"><h3>Tambah Harga Pokok Produksi</h3>

                                            <div class="form-group"><label class="col-sm-3 control-label">Nama Kebutuhan Produksi</label>

                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input type="text" class="form-control" name="nama_bahan_baku" value="" required=""/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Biaya Kebutuhan Produksi</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input type="number" class="form-control" name="harga_bahan_baku" value=""/></div>
                                                    </div>
                                                </div>
                                            </div>                                    
                                            <hr/>
