                                            ...
                                            <div class="col-lg-12">
                                                <div class="panel">
                                                    <div class="panel-heading">                                
                                                        <a href="<?php echo base_url(); ?>index.php/C_TransaksiPenjualan/tampilkanFormInputTransaksiPenjualan/">Tambah Transaksi Penjualan</a> 
                                                        <p style="color:red;">
                                                            <?php
                                                            if (isset($notif)) {
                                                                echo $notif;
                                                            ...
                                                            <div class="jplist-panel box panel-top">
                                                                ...
                                                                <div data-control-type="drop-down" data-control-name="sort" data-control-action="sort" data-datetime-format="{year}/{month}/{day}" class="jplist-drop-down form-control">
                                                                    <ul class="dropdown-menu">
                                                                        ...
                                                                        <li><span data-path=".desc" data-order="asc" data-type="text">Pembelian A-Z</span></li>
                                                                        <li><span data-path=".desc" data-order="desc" data-type="text">Pembelian Z-A</span></li>
                                                                        <li><span data-path=".jenis" data-order="asc" data-type="text">Jenis A-Z</span></li>
                                                                        <li><span data-path=".jenis" data-order="desc" data-type="text">Jenis Z-A</span></li>
                                                                        <li><span data-path=".jumlah" data-order="asc" data-type="number">Jumlah Terkecil</span></li>
                                                                        <li><span data-path=".jumlah" data-order="desc" data-type="number">Jumlah Terbesar</span></li>                                                                        
                                                                ...
                                                                <div class="text-filter-box">
                                                                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span><input data-path=".title" type="text" value="" placeholder="Nama Pembeli" data-control-type="textbox" data-control-name="title-filter" data-control-action="filter" class="form-control"/></div>
                                                                </div>
                                                                <div class="text-filter-box">
                                                                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span><input data-path=".desc" type="text" value="" placeholder="Pembelian" data-control-type="textbox" data-control-name="desc-filter" data-control-action="filter" class="form-control"/></div>
                                                                </div>
                                                                ...
                                                                <table class="table table-hover table-striped demo-tbl">
                                                                    ...
                                                                    <tbody>
                                                                        <?php foreach ($transaksi as $t) { ?>
                                                                            ...
                                                                            <tr class="tbl-item">
                                                                                <td class="id"><?php echo $t->id_transaksi; ?></td>
                                                                                <td class="title"><?php echo $t->nama_pembeli; ?></td>
                                                                                <td class="desc"><?php echo $t->nama_barang; ?></td>
                                                                                <td class="jenis"><?php echo $t->jenis_barang_pembelian; ?></td>
                                                                                <td class="jumlah"><?php echo $t->jumlah_pembelian; ?></td>
                                                                                <td class="harga"><?php echo $t->tanggal_pembelian; ?></td>
                                                                                <td><?php echo number_format($t->harga, 2, ',', '.'); ?></td>
                                                                                <td><a href="<?php echo base_url(); ?>index.php/C_TransaksiPenjualan/tampilkanFormEditTransaksiPenjualan/<?php echo $t->id_transaksi; ?>"><i class="fa fa-edit fa-fw"/></a></td>
                                                                                <td><a href="javascript:konfirmasi('<?php echo base_url(); ?>index.php/C_TransaksiPenjualan/hapusDataTransaksiPenjualan/<?php echo $t->id_transaksi; ?>')"><i class="fa fa-trash-o fa-fw"/></a></td>
                                                                            </tr>
                                                                        <?php } ?>
                                                                    </tbody>
                                                                </table>
