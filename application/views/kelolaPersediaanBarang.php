                                            ...
                                            <div class="col-lg-12">
                                                <div class="panel">
                                                    <div class="panel-heading">                                
                                                        <a href="<?php echo base_url(); ?>index.php/C_persediaanBarang/tampilkanFormInputPersediaan/">Tambah Persediaan Barang</a> 
                                                        <p style="color:red;">
                                                            <?php
                                                            if (isset($notif)) {
                                                                echo $notif;
                                                            ...
                                                            <div class="jplist-panel box panel-top">
                                                                ...
                                                                <div data-control-type="drop-down" data-control-name="sort" data-control-action="sort" data-datetime-format="{year}/{month}/{day}" class="jplist-drop-down form-control">
                                                                    <ul class="dropdown-menu">
                                                                        ...
                                                                        <li><span data-path=".jumlah" data-order="asc" data-type="number">Jumlah Kecil</span></li>
                                                                        <li><span data-path=".jumlah" data-order="desc" data-type="number">Jumlah Besar</span></li>
                                                                ...
                                                                <div class="text-filter-box">
                                                                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span><input data-path=".title" type="text" value="" placeholder="Nama Barang" data-control-type="textbox" data-control-name="title-filter" data-control-action="filter" class="form-control"/></div>
                                                                </div>
                                                                <div class="text-filter-box">
                                                                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span><input data-path=".desc" type="text" value="" placeholder="Jenis Barang" data-control-type="textbox" data-control-name="desc-filter" data-control-action="filter" class="form-control"/></div>
                                                                </div>
                                                                ...
                                                                <table class="table table-hover table-striped demo-tbl">
                                                                    ...
                                                                    <tbody>
                                                                        <?php foreach ($barang as $b) { ?>
                                                                            ...
                                                                            <tr class="tbl-item">
                                                                                <td class="id"><?php echo $b->id_barang; ?></td>
                                                                                <td class="title"><?php echo $b->nama_barang; ?></td>
                                                                                <td class="desc"><?php echo $b->jenis_barang; ?></td>
                                                                                <td class="jumlah"><?php echo $b->jumlah_barang; ?></td>
                                                                                <td class="harga"><?php echo number_format($b->harga_barang, 2, ',', '.'); ?></td>
                                                                                <td><?php echo $b->tanggal_barang_masuk; ?></td>
                                                                                <td><a href="<?php echo base_url(); ?>index.php/C_persediaanBarang/tampilkanFormEditPersediaanBarang/<?php echo $b->id_barang; ?>"><i class="fa fa-edit fa-fw"/></a></td>
                                                                                <td><a onclick="" href="javascript:konfirmasi('<?php echo base_url(); ?>index.php/C_persediaanBarang/hapusDataPersediaanBarang/<?php echo $b->id_barang; ?>')"><i class="fa fa-trash-o fa-fw"/></a></td>
                                                                            </tr>
                                                                        <?php } ?>
                                                                    </tbody>
                                                                </table>
