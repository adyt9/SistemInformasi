                                ...
                                <div class="col-lg-12">
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        <?php foreach ($barang as $b) {
                                            ?>
                                            <form action="<?php echo base_url() ?>index.php/C_persediaanBarang/editDataPersediaanBarang" class="form-horizontal" method="post"><h3>Edit Persediaan Barang</h3>

                                                <div class="form-group"><label class="col-sm-3 control-label">ID Barang</label>

                                                    <div class="col-sm-9 controls">
                                                        <div class="row">
                                                            <div class="col-xs-9"><input type="text" class="form-control" value="<?php echo $b->id_barang; ?>" disabled=""/></div>
                                                            <input type="hidden" class="form-control" name="id_barang" value="<?php echo $b->id_barang; ?>"/>
                                                        </div>
                                                    </div>
                                                </div>                                
                                                <div class="form-group"><label class="col-sm-3 control-label">Nama Barang</label>
                                                    ...
                                                    <div class="col-sm-9 controls">
                                                        <div class="row">
                                                            <div class="col-xs-9"><input type="text" class="form-control" name="nama_barang" value="<?php echo $b->nama_barang; ?>" required=""/></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-4">
                                                                <select class="form-control" name="jenis_barang" required="">
                                                                    <option selected=""><?php echo $b->jenis_barang; ?></option>
                                                ...
                                                <div class="form-group"><label class="col-sm-3 control-label">Jumlah Barang</label>
                                                    ...
                                                    <div class="col-sm-9 controls">
                                                        <div class="row">
                                                            <div class="col-xs-9"><input type="number" class="form-control" name="jumlah_barang" value="<?php echo $b->jumlah_barang; ?>" required=""/></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group"><label class="col-sm-3 control-label">Harga Barang</label>
                                                    ...
                                                    <div class="col-sm-9 controls">
                                                        <div class="row">
                                                            <div class="col-xs-9"><input type="number" class="form-control" name="harga_barang" value="<?php echo $b->harga_barang; ?>" required=""/></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group"><label class="col-sm-3 control-label">Tanggal Barang Diterima</label>
                                                    ...
                                                    <div class="col-sm-9 controls">
                                                        <div class="row">
                                                            <div class="col-xs-9"><input type="date" class="form-control" name="tanggal_barang_masuk" placeholder="YYYY-MM-DD ex:2017-01-30" value="<?php echo $b->tanggal_barang_masuk; ?>" required="" max="<?php echo date("Y-m-d"); ?>"/></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group"><label class="col-sm-3 control-label">Tanggal Barang Keluar</label>
                                                    ...
                                                    <div class="col-sm-9 controls">
                                                        <div class="row">
                                                            <div class="col-xs-9"><input type="date" class="form-control" name="tanggal_barang_keluar" placeholder="YYYY-MM-DD ex:2017-01-30" value="<?php echo $b->tanggal_barang_keluar; ?>" max="<?php echo date("Y-m-d"); ?>"/></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr/>
