                    ...
                    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                        <div class="page-header pull-left">
                            <div class="page-title">
                                Kelola Harga Pokok Produksi</div>
                        </div>                        
                        <div class="clearfix">
                        </div>
                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        <?php foreach ($produksi as $p) {
                                            ?>
                                            <form action="<?php echo base_url() ?>index.php/C_produksi/editDataHargaPokokProduksi" class="form-horizontal" method="post"><h3>Tambah Harga Pokok Produksi</h3>
                                                <div class="form-group"><label class="col-sm-3 control-label">ID Produksi</label>

                                                    <div class="col-sm-9 controls">
                                                        <div class="row">
                                                            <div class="col-xs-9"><input type="text" class="form-control" name="id_bahan_baku" value="<?php echo $p->id_bahan_baku; ?>" required="" disabled=""/></div>
                                                            <input type="hidden" name="id_bahan_baku" value="<?php echo $p->id_bahan_baku; ?>"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group"><label class="col-sm-3 control-label">Nama Kebutuhan Produksi</label>

                                                    <div class="col-sm-9 controls">
                                                        <div class="row">
                                                            <div class="col-xs-9"><input type="text" class="form-control" name="nama_bahan_baku" value="<?php echo $p->nama_bahan_baku; ?>" required=""/></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group"><label class="col-sm-3 control-label">Jenis Kebutuhan Produksi</label>

                                                    <div class="col-sm-9 controls">
                                                        <div class="row">
                                                            <div class="col-xs-4">
                                                                <select class="form-control" name="jenis_bahan_baku"> 
                                                                    <option value="<?php echo $p->jenis_bahan_baku; ?>" selected=""><?php echo $p->jenis_bahan_baku; ?></option>  
                                                                    ...
                                                                    <option value="Biaya Overhead Variabel">Biaya Overhead Variabel</option>   
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group"><label class="col-sm-3 control-label">Biaya Kebutuhan Produksi</label>

                                                    <div class="col-sm-9 controls">
                                                        <div class="row">
                                                            <div class="col-xs-9"><input type="number" class="form-control" name="harga_bahan_baku" value="<?php echo $p->harga_bahan_baku; ?>"/></div>
                                                        </div>
                                                    </div>
                                                </div>                                    
                                                <hr/>
