                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        ...
                                        <form action="<?php echo base_url() ?>index.php/C_TransaksiPenjualan/simpanDataTransaksiPenjualan" class="form-horizontal" method="post"><h3>Tambah Transaksi Penjualan</h3>

                                            <div class="form-group"><label class="col-sm-3 control-label">Nama Pembeli</label>

                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input type="text" class="form-control" name="nama_pembeli" value="" required=""/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Jumlah Pembelian</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input type="number" class="form-control" name="jumlah_pembelian" value="" required=""/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-3 control-label">Tanggal Pembelian</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input type="date" class="form-control" name="tanggal_pembelian" placeholder="YYYY-MM-DD ex:2017-01-30" value="" required="" max="<?php echo date("Y-m-d"); ?>"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-3 control-label">Harga</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input type="number" class="form-control" name="harga" value="" required=""/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <hr/>
